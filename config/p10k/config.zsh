# Generated by Powerlevel10k configuration wizard on 2025-12-13 at 12:02 CET.
...
# round separators, round heads, blurred tails, 1 line, compact, many icons, concise,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=105
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=62
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=105
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=105
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    "($SCRIPT_ROOT|${XDG_CONFIG_HOME-"$HOME/.config"})"'(|/*)' CONFIG     ''
    '/etc(|/*)'                     CONFIG    ''
    "(|/mnt)$HOME"'/Music(|/*)'     MUSIC     ''
    "(|/mnt)$HOME"'/Videos(|/*)'    VIDEOS    ''
    "(|/mnt)$HOME"'/Pictures(|/*)'  PICTURES  ''
    "(|/mnt)$HOME"'/Documents(|/*)' DOCUMENTS ''
  )
  typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_CONFIG_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='  '
  typeset -g POWERLEVEL9K_DIR_MUSIC_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_VIDEOS_VISUAL_IDENTIFIER_EXPANSION='󰿏 '
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=111
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=223
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=110
